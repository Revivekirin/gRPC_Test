...
class TargetServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendRequest = channel.unary_unary(
                '/grpc_project.TargetService/SendRequest',
...
def add_TargetServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'grpc_project.TargetService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('grpc_project.TargetService', rpc_method_handlers)
